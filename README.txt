...
5. Run the Test Script: Execute the test script by running the following command in the terminal: python test.py
This will load the best DNN model (DNN-30-8) and print the predictions for the test set. The output will display an array of predicted TARGET_deathRate values.